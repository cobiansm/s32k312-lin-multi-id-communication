...
#define LPUART_LIN_IP_SA_PBCFG_SW_MAJOR_VERSION_C              5
...
*
*/
const Lpuart_Lin_Ip_UserConfigType Lpuart_Lin_Ip_Sa_pxHwConfigPB_0 =
{

    5U, /*!< Hardware instance */

    0x61U, /*!< Baudrate divisor */
